...
def createDispositivo():
  ...
  for value in reqJSON:
    posibleValues = ["nombre de equipo", "tipodispositivoId", "fecha_de_alta", "fecha_de_actualización", "potencia_actual", "statusDispositivoId"]
    if value in posibleValues: 
      newDispositivo[value] = reqJSON[value]
