...
def createDispositivo():
  ...
  id = reqJSON[id]
  nombre_de_equipo = reqJSON[nombre_de_equipo]
  tipodispositivoId = reqJSON[tipodispositivoId]
  fecha_de_alta = reqJSON[fecha_de_alta]
  fecha_de_actualización = reqJSON[fecha_de_actualización]
  potencia_actual = reqJSON[potencia_actual]
  statusDispositivoId = reqJSON[statusDispositivoId]
